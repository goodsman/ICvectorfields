...
#'
#' @param inputdf a data frame object in which the first column is longitude, the
...
#'
#' @return The function returns a raster stack constructed using inputdf. Each layer in the stack corresponds
