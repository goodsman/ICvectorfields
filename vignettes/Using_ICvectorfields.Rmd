...
The functionality of *ICvectorfields* is demonstrated using one simulated dataset and two empirical datasets that accompany the package.
...
## Demonstration using Seasonal Copepod Abundance Data
...
# convert to raster stack
CopeStack <- ICvectorfields::RastStackData(Copepod)
...
# ensuring that terra recognises output as rast
CopeStack <- terra::rast(CopeStack)
dim(CopeStack)

# visualizing
terra::plot(CopeStack[[1]], legend = FALSE, main = "May")
terra::plot(CopeStack[[2]], legend = FALSE, main = "June")
terra::plot(CopeStack[[3]], legend = FALSE, main = "July")
```
