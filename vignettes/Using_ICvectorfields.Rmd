...
The analysis reveals that northward movement is slower than movement from the east to the west. In addition,
average speed and standard deviation can be computed.
