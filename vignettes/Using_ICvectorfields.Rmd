...
Aggregated larch budmoth data that were used to demonstrate the existence of wave-trains [@Bjornstad2002] are provided as part of the ncf package [@ncf]. In the plot below the first five years of a time series that extends from 1961 to 1998 are plotted.
